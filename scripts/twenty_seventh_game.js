let data = [
  ...
  {
    img: "basketbolchi.jpg",
    "name-uzb": "Basketbolchi",
    "name-eng": "Basketball Player",
  },
  ...
  {
    img: "elektromobil.jpg",
    "name-uzb": "Elektromobil",
    "name-eng": "Electric Car",
  },
  {
    img: "elon-musk-portrait.jpg",
    "name-uzb": "milliader",
    "name-eng": "billionaire",
  },
  ...
  {
    img: "playstayshn.jpg",
    "name-uzb": "Playstayshn",
    "name-eng": "PlayStation",
  },
  ...
  {
    img: "suv_motosikli.jpg",
    "name-uzb": "Suv Motosikli",
    "name-eng": "Jet Ski",
  },
  {
    img: "suv_tomchisi.png",
    "name-uzb": "Suv Tomchisi",
    "name-eng": "Water Drop",
  },
...
let plusNum = document.getElementById("ch_num");
let beginButton = document.querySelector(".begin_button");
let section = document.querySelector("section");
let checkImp = document.getElementById("check_imp")
...
beginButton.onclick = () => {
  tanlanganlar = [];
  section.innerHTML = ''
  let count = parseInt(plusNum.value - 1);
  for (let i = 0; i <= count; i++) {
    let item = data[i];
    let wordsDisplay = document.createElement("div");
    wordsDisplay.classList.add("words_display");
    wordsDisplay.innerHTML = `
         <p class="uzb_name">${item["name-uzb"]}</p>
        <img src="../photos/twenty_seventh_game_photos/${item["img"]}" alt="Image">
        <p class="eng_name">${item["name-eng"]}</p>
    `;
    tanlanganlar.push(item)
    localStorage.setItem('word', JSON.stringify(tanlanganlar))
    section.appendChild(wordsDisplay);
    checkImp.onclick = ()=> {
        console.log("Ishladi")
       document.querySelectorAll(".words_display").forEach(element => {
